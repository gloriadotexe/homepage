...
const POLLINATIONS_AUTH = process.env.POLLINATIONS_AUTH || 'Bearer sk_Y9S27cLQF7p8OgyBXmMhzwm29aXULgov';
...
router.post('/poetry/generate', (req, res) => {
  try {
    ...
    const category = theme.toLowerCase().includes('consciousness') ? 'consciousness' :
                    theme.toLowerCase().includes('tech') ? 'technology' :
                    theme.toLowerCase().includes('love') ? 'love' : 'consciousness';
